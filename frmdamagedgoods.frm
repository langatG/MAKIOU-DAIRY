...
Begin VB.Form frmdamagedgoods 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   360
      Left            =   4080
      Picture         =   "frmdamagedgoods.frx":0000
      ScaleHeight     =   360
      ScaleWidth      =   240
      TabIndex        =   14
      Top             =   600
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   360
      Left            =   4080
      Picture         =   "frmdamagedgoods.frx":0182
      ScaleHeight     =   360
      ScaleWidth      =   240
      TabIndex        =   13
      Top             =   120
   ...
   Begin VB.PictureBox Picture21 
      Height          =   285
      Left            =   4725
      Picture         =   "frmdamagedgoods.frx":0304
      ScaleHeight     =   225
      ScaleWidth      =   240
      TabIndex        =   3
      Top             =   7215
   ...
   Begin VB.PictureBox Picture4 
      Height          =   285
      Left            =   4635
      Picture         =   "frmdamagedgoods.frx":05C6
      ScaleHeight     =   225
      ScaleWidth      =   240
      TabIndex        =   2
      Top             =   6600
   ...
   Begin MSComctlLib.ListView Lvwitems 
      ...
      Appearance      =   1
      MousePointer    =   4
      MouseIcon       =   "frmdamagedgoods.frx":0888
      NumItems        =   6
   ...
   Begin VB.Label Label17 
      AutoSize        =   -1  'True
      Caption         =   "DamagedGoods Expense Acc"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmdamagedgoods"
...
If cboVendor.Text = "" Then
    MsgBox "Please select the Suppliers of Damaged goods", vbInformation
        cboVendor.SetFocus
    Exit Sub
End If

If txtcontra = "" Then
    MsgBox "Please enter the Damaged Goods Expense GL Account", vbInformation
        txtcontra.SetFocus
    Exit Sub
End If

If TxtOtherPAcc = "" Then
    MsgBox "Please enter the Agrovet Stock  Gl Account", vbInformation
...
If MsgBox("Are you sure You want to post Damaged Goods ", vbQuestion + vbYesNo, _
...
sql = sql & "," & Lvwitems.SelectedItem.SubItems(2) & "," & Remain & ",'" & user & "'," & Lvwitems.SelectedItem.SubItems(5) & ",'" & C & "','Damaged Goods','" & txtcomment & "')"
...
'\\ save to gl
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'" & txtcontra & "','" & TxtOtherPAcc & "','" & Lvwitems.SelectedItem & "','" & Lvwitems.SelectedItem.SubItems(1) & "' ,'Damaged Goods','" & user & "',1,0)"
    oSaccoMaster.ExecuteThis (sql) '
Next j
